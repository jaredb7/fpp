    ...
    <?}?>
		...
		<div id='divLEDPanelsData'>
			<div style="padding: 10px;">
                ...
                <div id="divLedPanelsLayoutDataOptions">
                ...
                <br>
                <div class="ledPanelsLayoutHints">
                    ...
                    - Arrow <img src='images/arrow_N.png' height=17 width=17> indicates panel orientation, click arrow
                    to rotate.<br>
                </div>
                <br>
                <div class="ledPanelsNotesAndHints">
                <b>Notes and hints:</b>
                <ul>
<?if (count($panelCapes) == 1) {
